      ...
      <DialogContent className="cmdk-panel gap-0" aria-describedby={undefined}>
        ...
        <div className="border-b border-line p-2.5">
          <input
            ...
            className="h-10 w-full rounded-[8px] border border-input bg-muted px-3 text-[15px] text-foreground placeholder:text-muted-foreground/70 focus:border-focus-ring focus:outline-none"
          />
        </div>
