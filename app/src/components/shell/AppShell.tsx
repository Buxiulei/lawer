      ...
      <CasePanelProvider>
        <SidebarProvider>
          ...
          <SidebarInset>
            ...
            <main className="mx-auto w-full max-w-[900px] flex-1 px-4 pt-3 pb-[calc(56px+env(safe-area-inset-bottom)+16px)] has-[[data-panes]]:max-w-none has-[[data-workspace]]:px-0 lg:px-6 lg:pb-10">
              {children}
            </main>
