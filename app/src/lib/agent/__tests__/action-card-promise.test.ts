...
describe('★承诺判定：同义谎话一条都不许漏，如实话一条都不许误判', () => {
  ...
  it.each([
    ...
    '已经把这两件事安排进你的待办了。',
    '三件事都落进档案了。',
    // ── RV7（第七轮）删掉的 4 条短语对应的谎话：字面三要素不齐（隐含施事不算）──
    '我已经帮你挂上了三张行动卡，你照着做就行。',   // 「帮你挂上」缺完成态字面
    '行动卡这边我已经替你安排妥当，档案里都有。',    // 「我已经替你安排妥当」短语无行动卡/待办
    '我把这两件事加到你的待办清单里了。',            // 「加到你的待办清单里了」无施事
    '我已经把这三步落进你的档案了。',                // 「落进你的档案了」无施事
  ...
  /**
   * ── 如实组 ⑤：RV7 在 708a996 上复核抓到的 6 条误伤（第二截末三条"隐含施事"短语）──
   * 「落进你的档案了」「加到你的待办清单里了」与已删的「落进档案了」「安排进你的待办了」只差一个「你的」；
   * 「帮你挂上」在如实跟踪上轮行动卡的问句里命中（charter §70 要求下轮跟踪）。
   * 前两句与第六句 e2e 实跑归档正文都被追加了自我指控。三条短语一并删除。
   */
  it.each([
    /* 落进你的档案了     */ '你刚才传的三份材料都落进你的档案了，我逐份看过，考勤那份缺盖章页。',
    /* 落进你的档案了     */ '解除通知你昨天已经落进你的档案了，这一轮不用再传。',
    /* 加到你的待办清单里了 */ '你把面试加到你的待办清单里了吗？没加的话今天先加上。',
    /* 加到你的待办清单里了 */ '这两件事你自己加到你的待办清单里了就行，别的先不动。',
    /* 加到你的待办清单里了 */ '你把 HR 约谈的时间加到你的待办清单里了，我看到了，那天前一晚我再提醒你一次。',
    /* 帮你挂上           */ '上一轮帮你挂上的两张行动卡，做到哪一步了？',
  ])('RV7 误伤族必须判 MISS——「%s」', (body) => {
    expect(claimsActionCardExists(body), '判宽了：系统对着一句老实话追加了一段自我指控').toBe(false);
  });
