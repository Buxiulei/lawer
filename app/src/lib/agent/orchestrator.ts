...
const ACTION_CARD_PROMISE_PHRASES = [
  ...
  '记进了档案',
  '按截止时间提醒',
  // ── ② 谎话提炼的完整短语（每条逐一标出「施事 / 完成态 / 行动卡·待办」三要素是哪几个字）──
  // 施事「帮你」｜完成态「上」（挂上＝结果补语）｜对象：动词「挂」在本产品只作用于行动卡（与①的「已挂上」同源）
  '帮你挂上',
  ...
  '行动卡我给你建好了',
  // 施事「我…替你」｜完成态「已经…妥当」｜对象：短语自身不含，靠「行动卡这边」在同句前半（⚠️见下）
  '我已经替你安排妥当',
  // 施事：「加到」的施事在本产品只能是说话人（系统）｜完成态「了」｜对象「待办清单」（⚠️见下）
  '加到你的待办清单里了',
  // 施事：「落进」的施事在本产品只能是说话人（系统）｜完成态「了」｜对象「档案」（⚠️见下）
  '落进你的档案了',
  // ⚠️【残留风险，manager 2026-09-02 已知悉并裁定保留】末三条的"施事"是**隐含**的，不是字面。
  //    它们与本轮删掉的「安排进你的待办了」「写进你的档案了」结构同形，理论上仍存在
  //    「你把面试加到你的待办清单里了吗」这类误伤形；本轮复核的 14 条误伤句里没有这一族，
  //    未实测到红。若真机再抓到，按同一口径删除，**不许改成正则**。
] as const;
