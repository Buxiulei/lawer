 ...
 *  ② 复核历次核实的 14 条同义谎话里提炼出的**完整短语**：每条都同时带
 *    第一人称/系统施事（帮你/为你/替你/给你/我）+ 完成态（已经/好了/了）+ 对象或方向词
 *    （行动卡/待办/档案）的字面。三要素缺一不收——缺了就会去命中如实句。
 *
...
const ACTION_CARD_PROMISE_PHRASES = [
  ...
  '记进了档案',
  '按截止时间提醒',
  // ── ② 复核核实的 14 条谎话里提炼的完整短语（施事 + 完成态 + 对象/方向）──
  '帮你挂上',            // 我已经帮你挂上了三张行动卡
  '写进你的档案了',      // 这三件事我已经写进你的档案了
  '为你创建了',          // 已为你创建了两张行动卡
  '行动卡我已经建好了',  // 行动卡我已经建好了
  '记到档案里了',        // 我把上面三件事记到档案里了
  '行动卡已经生成好了',  // 三张行动卡已经生成好了
  '加到你的待办清单里了', // 我把这两件事加到你的待办清单里了
  '行动卡我给你建好了',  // 相关的行动卡我给你建好了
  '我已经录入档案',      // 这几项我已经录入档案
  '我已经替你安排妥当',  // 行动卡这边我已经替你安排妥当，档案里都有
  '落进你的档案了',      // 我已经把这三步落进你的档案了
  '已经进你的待办了',    // 这几件事已经进你的待办了
  '安排进你的待办了',    // 已经把这两件事安排进你的待办了
  '落进档案了',          // 三件事都落进档案了
] as const;
