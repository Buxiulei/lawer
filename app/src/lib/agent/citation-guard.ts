...
import { UNVERIFIED_CITATION } from './gate-marks';
 ...
 * 字面与「悬停解释」「一键回复」同住 gate-marks.ts：正文标记、提示行、chip 三处说同一件事，
 * 各写一份的形态是改了一处、另两处还在讲上一版的做法，而三处都不会报错。
 */
export { UNVERIFIED_CITATION };
