...
| WS2 | 后台技术 | app骨架+auth(OTP/邮箱)+sidecar(TSA/PAdES/OCR/ASR)+llm路由+MCP/API | ws/backend | 开发中（第一波：骨架+crypto/sidecar/deploy 并行） | 无依赖项今天内，MCP/API 等WS1 | crypto 接口今天先出给WS1；MCP依赖WS1表结构 |
